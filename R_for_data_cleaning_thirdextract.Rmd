...
# Data cleaning
## Filter for cases with consent and < 18
```{r}
...
## Filter for cases from the official launch date (including responses from Denmark & Kosovo before 03/30)
```{r}
